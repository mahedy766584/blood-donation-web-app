            ...
            <div className="bg-gradient-to-r from-white bg-opacity-20  w-full h-full  absolute top-0">
                <Container>
                    <div className='flex lg:justify-start justify-center items-center'>
                        <div className="lg:space-y-10 space-y-8 lg:mt-28 w-full">
                            <h1 className="text-[#EA062B] text-4xl font-bold hero-title">Donate blood, save life !</h1>
                            <h1 className='lg:text-6xl text-5xl font-bold text-gray-900 hero-title '>Your Blood, <br /> Their Hope: Join <br /> the Life-Saving Mission</h1>
